          ...
          <div className="flex-grow flex flex-col items-center justify-center p-6 min-h-[90vh]">
            <div className="w-full max-w-sm flex flex-col items-center">
              ...
              <div className="mb-8 transform hover:scale-[1.02] transition-duration-500 flex flex-col items-center">
                ...
                <span className="text-lg font-light tracking-wide text-white mt-4 font-display">XENITH</span>
                <span className="text-[10px] tracking-wide text-[#f4cf8a] uppercase mt-1.5 ">Partner Integration Framework</span>
              </div>
                ...
                <AnimatePresence mode="wait">
                  ...
                  {authStep === "idle" && (
                    <motion.div
                      ...
                      exit={{ opacity: 0, y: -10 }}
                    >
                      <h3 className="text-xs font-semibold tracking-wide text-[#f4cf8a] uppercase text-center mb-6 font-display">
                      ...
                      <form onSubmit={handlePartnerLogin} className="space-y-4">
                        ...
                        <div className="relative">
                          ...
                          <input 
                            ...
                            className="w-full bg-black/60 border border-white/[0.06] hover:border-white/15 focus:border-[#f4cf8a]/40 rounded-xl py-4.5 pl-11 pr-4 text-base sm:text-xs tracking-wide text-[#f4cf8a]  placeholder:text-white/20 placeholder:tracking-normal outline-none transition duration-200"
                          />
                        </div>
                        ...
                        <div className="relative">
                          ...
                          <input 
                            ...
                            className="w-full bg-black/60 border border-white/[0.06] hover:border-white/15 focus:border-[#f4cf8a]/40 rounded-xl py-4.5 pl-11 pr-11 text-base sm:text-xs tracking-wide text-white/80  placeholder:text-white/20 placeholder:tracking-normal outline-none transition duration-200"
                          />
                          <button 
                            type="button"
                            onClick={() => setShowPasskey(!showPasskey)}
                            className="absolute right-1 top-1/2 -translate-y-1/2 p-2.5 text-white/30 hover:text-white transition duration-150"
                          >
                        ...
                        <button 
                          type="submit"
                          className="w-full rounded-xl bg-gradient-to-r from-[#eac57d] via-[#f4cf8a] to-[#ecd4a5] text-black text-[10px] font-semibold tracking-wide py-4 mt-4 transition duration-300 hover:opacity-90 active:scale-98 shadow-md shadow-[#f4cf8a]/10 cursor-pointer flex items-center justify-center gap-2 uppercase"
                        >
                          Decrypt Credentials
                        </button>
                      </form>
                  ...
                  {authStep === "decrypting" && (
                    ...
                    >
                      ...
                      <h4 className="text-[10px]  tracking-wide uppercase text-white/90">Decryption Protocol Initiated</h4>
                  ...
                  {authStep === "biometric" && (
                    ...
                    >
                      ...
                      <h4 className="text-[10px]  tracking-wide uppercase text-emerald-400">Handshake Signature Check</h4>
                      <div className="text-[10px]  text-white/90 tracking-wide mt-2">CYPHER SECURITY PASSED</div>
                  ...
                  {authStep === "success" && (
                    ...
                    >
                      ...
                      <h4 className="text-[10px]  tracking-wide uppercase text-emerald-400">Authenticated</h4>
          ...
          <div className="flex-grow w-full max-w-4xl mx-auto px-6 py-8 space-y-6">
            ...
            <header className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-white/[0.04] pb-6 gap-4 select-none">
              ...
              >
                ...
                <span className="text-sm font-semibold tracking-wide text-white font-display select-none">XENITH</span>
              </div>
              ...
              <div className="flex items-center gap-3.5 sm:self-center">
                <button 
                  ...
                  className="rounded border border-amber-500/20 px-5 py-2.5 sm:py-1.5 text-[9px] tracking-wide uppercase text-[#f4cf8a] hover:bg-[#f4cf8a]/5 transition cursor-pointer font-semibold"
                >
                  Sign Out
                </button>
                <div className="rounded border border-white/[0.08] bg-black/30 text-white/80 px-4 py-1.5 text-[9px] tracking-wide flex items-center gap-1.5  select-none">
            ...
            <section className="space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-white/[0.03] pb-3.5 select-none">
                <div className="space-y-1">
                  <h3 className="text-[11px] tracking-wide font-medium text-[#f4cf8a] font-display uppercase">
                ...
                <div className="flex flex-col sm:items-end gap-1.5 tracking-wider text-right">
                  ...
                  <div className="bg-[#f4cf8a]/10 border border-[#f4cf8a]/30 text-[#f4cf8a] font-bold px-4 py-1.5 rounded flex items-center justify-center gap-1.5 select-none text-[10px] tracking-wide ">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
                ...
                <div className="md:col-span-4 rounded-xl border border-white/[0.05] bg-[#0c090a]/40 p-6 flex flex-col justify-between shadow-md min-h-[160px] select-none">
                  <div className="text-[9px]  tracking-wide text-[#f4cf8a] uppercase">
                ...
                <div className="md:col-span-8 rounded-xl border border-white/[0.05] bg-[#0c090a]/40 p-6 flex flex-col justify-between shadow-md overflow-hidden relative">
                  ...
                  <div className="text-[9px]  tracking-wide text-[#f4cf8a] uppercase mb-4 text-center">
                  ...
                  <div className="text-center mt-3.5 text-[9px]  tracking-wide text-[#f4cf8a]/80 select-none">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-6 rounded-xl border border-white/[0.05] bg-[#0c090a]/40 p-6 flex flex-col justify-between shadow-md space-y-4">
                <div className="flex items-center justify-between border-b border-white/[0.03] pb-3 select-none">
                  <h3 className="text-[10px] tracking-wide font-medium text-[#f4cf8a] font-display uppercase">
                  ...
                  <button 
                    ...
                    className="text-[9px]  border border-[#f4cf8a]/30 bg-black hover:bg-[#f4cf8a]/5 text-[#f4cf8a] transition-all px-3 py-2 sm:py-1 rounded cursor-pointer shrink-0"
                  >
                    ...
                    >
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                        <input
                          ...
                          className="flex-grow bg-black border border-white/10 rounded px-2.5 py-1.5 text-base sm:text-xs text-white placeholder:text-white/20 outline-none"
                        />
                        <select 
                          value={newMemberPackage}
                          onChange={(e) => setNewMemberPackage(e.target.value as any)}
                          className="bg-black border border-white/10 rounded px-2.5 py-1.5 text-base sm:text-xs text-white outline-none cursor-pointer"
                        >
                      ...
                      <button 
                        type="submit"
                        className="w-full bg-[#f4cf8a] hover:bg-[#ebd09d] text-black text-[9px]  uppercase tracking-wide font-semibold py-1.5 rounded transition cursor-pointer"
                      >
                        Confirm Allocation
                      </button>
                    </motion.form>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left font-sans text-xs">
                    <thead>
                      <tr className="text-white/30 uppercase tracking-wide text-[9px] border-b border-white/[0.04]">
              ...
              <div className="lg:col-span-6 space-y-4">
                ...
                <div className="rounded-xl border border-white/[0.05] bg-[#0c090a]/40 p-5 flex items-center justify-between gap-3 shadow-md relative group select-none">
                  <div className="space-y-4 max-w-[78%] sm:max-w-[70%]">
                    <div className="text-[9px]  tracking-wide text-[#f4cf8a] uppercase">
                  ...
                  <div className="w-12 h-12 shrink-0 rounded-full border border-[#f4cf8a]/30 bg-[#f4cf8a]/5 flex items-center justify-center text-[#f4cf8a]  text-[10px] tracking-wide font-bold shadow-[0_0_15px_rgba(244,207,138,0.06)] group-hover:scale-105 group-hover:border-[#f4cf8a]/50 transition duration-300">
                    RM
                  </div>
                </div>
                ...
                <div className="rounded-xl border border-white/[0.05] bg-[#0c090a]/40 p-5 flex items-center justify-between shadow-md relative group select-none overflow-hidden">
                  ...
                  <div className="w-[90px] sm:w-[120px] h-[50px] relative shrink-0">
            ...
            <section className="rounded-2xl border border-[#f4cf8a]/35 bg-[linear-gradient(135deg,#0a0806_0%,#18120d_100%)] p-6 sm:p-8 relative overflow-hidden select-none shadow-[0_12px_24px_rgba(0,0,0,0.4)]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
                ...
                <div className="md:col-span-6 space-y-1 text-center sm:text-left">
                  <h3 className="text-[9px] tracking-wide font-medium text-[#f4cf8a] uppercase font-display">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-6 rounded-xl border border-white/[0.05] bg-[#0c090a]/40 p-6 flex flex-col justify-between shadow-md space-y-5 select-none">
                ...
                <div className="space-y-2.5 font-sans text-xs">
                  <div className="flex flex-wrap items-center justify-between gap-x-3 min-w-0 pb-1.5 border-b border-white/[0.03]">
                    <span className="text-white/40 shrink-0">Node Level:</span>
                    <span className="text-emerald-400 font-semibold text-sm text-right break-words">Genesis Node (Level Black)</span>
                  </div>
                  <div className="flex flex-wrap items-center justify-between gap-x-3 min-w-0 pb-1.5 border-b border-white/[0.03]">
                    <span className="text-white/40 shrink-0">Authorized API Connections:</span>
                    <span className="text-amber-500 font-semibold text-sm text-right break-words">1 / 3 Links Active</span>
                  </div>
                ...
                <div className="flex items-center justify-center gap-6 py-4 border-t border-white/[0.02] ">
                  <div className="flex flex-col items-center gap-1">
                    ...
                    <span className="text-[10px] sm:text-[8px] tracking-wider text-white/30 uppercase mt-1 text-center leading-tight">Active Links</span>
                  </div>

                  {/* Flow Arrow representation */}
                  <div className="flex-grow max-w-[80px] h-px bg-white/10 relative flex items-center justify-center">
                    <span className="absolute -top-3 text-[10px] sm:text-[7px] text-[#f4cf8a]/50 uppercase tracking-wide  scale-90">Bandwidth</span>
                  ...
                  <div className="flex flex-col items-center gap-1">
                    ...
                    <span className="text-[10px] sm:text-[8px] tracking-wider text-white/30 uppercase mt-1 text-center leading-tight">Available Whitelists</span>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-6 rounded-xl border border-white/[0.05] bg-[#0c090a]/40 p-6 flex flex-col justify-between shadow-md space-y-4">
                ...
                <div className="grid grid-cols-3 gap-1.5 p-1 bg-black/40 rounded-lg border border-white/[0.03]">
                  <button 
                    ...
                    className={`py-3 sm:py-2 text-[9px] tracking-wide uppercase  rounded transition-all cursor-pointer ${
                  ...
                  <AnimatePresence mode="wait">
                    {activeSopTab === "incubation" && (
                      ...
                      >
                        ...
                        <p className="text-[11px] text-white/50 leading-relaxed text-left md:text-justify">
            ...
            <section className="rounded-xl border border-white/[0.05] bg-[#0c090a]/30 p-6 flex flex-col md:flex-row items-stretch justify-between shadow-md gap-6 select-none font-sans">
              <div className="md:max-w-[55%] flex flex-col justify-between space-y-4">
                <div className="space-y-2">
                  <h3 className="text-[10px] tracking-wide font-medium text-[#f4cf8a] uppercase font-display">
                    About Xenith
                  </h3>
                  <p className="text-xs leading-relaxed text-white/50 text-left md:text-justify">
            ...
            {/* 8. FOOTER STAMP */}
            <footer className="pt-8 border-t border-white/[0.03] text-center text-[9px] tracking-wide text-white/20 uppercase  space-y-3">
              <div>© 2025 Xenith. All rights reserved.</div>
              <div className="flex justify-center gap-4 text-white/40 hover:text-white/60 transition text-[10px] sm:text-[8.5px]">
