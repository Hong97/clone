    ...
    >
      ...
      <div className="flex items-center justify-between border-b border-white/10 px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-xs tracking-[0.2em] font-medium text-white">Xenith AI Assistant</div>
      ...
      <div className="flex-1 overflow-y-auto px-6 py-4 space-y-6">
        {messages.map((msg, idx) => (
          ...
          >
            <div className="flex items-center gap-2 mb-1.5 text-[10px] tracking-[0.15em] text-white/30 font-mono">
            ...
            >
              ...
              {msg.sources && msg.sources.length > 0 && (
                <div className="mt-4 pt-3 border-t border-white/5">
                  <div className="text-[10px] tracking-[0.2em] text-white/35 font-mono flex items-center gap-1.5 mb-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {msg.sources.map((src, sIdx) => (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-1.5 rounded bg-white/[0.03] hover:bg-white/[0.08] px-2.5 py-1 text-[11px] font-mono text-white/60 hover:text-white border border-white/5 transition"
                      >
        ...
        {isLoading && (
          <div className="flex flex-col items-start">
            <div className="flex items-center gap-2 mb-1 text-[10px] tracking-[0.15em] text-white/30 font-mono flex-wrap">
              <span>Xenith AI</span>
              <span>•</span>
      ...
      {messages.length < 3 && (
        <div className="px-6 py-2 border-t border-white/5 bg-black/20">
          <div className="text-[9px] tracking-[0.2em] text-white/30 mb-2 font-mono">Suggested Inquiries</div>
